				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent" style="padding-top: 21px;">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item">
								<a class="nav-link ar-head" href="dashbord_student.php" style="color: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
    letter-spacing: .5px;">Dashboard</a>
							</li>
						<li class="nav-item">
								<a class="nav-link" href="invite_in_stu.php" title="Login Here"  style="color: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
