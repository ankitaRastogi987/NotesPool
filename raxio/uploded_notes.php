...
<!-- ************************************************************* -->
                <span class="menu-title" style="font-size: 18px;"><?php echo $cou;?></span> <span style="background: #5b9fd0; border-radius: 50%;color: white;padding: 2px;">10</span>
              ...
              <div class="collapse" id="ui-basic<?php echo $count;$count++;?>">
                <ul class="nav flex-column sub-menu">       
                  <li class="nav-item"> <a class="nav-link" href="testing.php?course_id=<?php echo$cou;?>">All</a></li>           
                  <li class="nav-item"> <a class="nav-link" href="testing.php?course_id=<?php echo$cou;?>&&type=Subject_Notes">Subject Notes</a></li>
                  <li class="nav-item"> <a class="nav-link" href="testing.php?course_id=<?php echo$cou;?>&&type=Syllabus">Syllabus</a></li>
                  <li class="nav-item"> <a class="nav-link" href="testing.php?course_id=<?php echo$cou;?>&&type=Question_bank">Question bank</a></li>
                  <li class="nav-item"> <a class="nav-link" href="testing.php?course_id=<?php echo$cou;?>&&type=Previous_year_ppr">Previous year ppr</a></li>
                </ul>
              </div>
        </ul>
        <?php 
						...
						<div class="row mamunurrashid_gig_wraper" style="margin-top: 0px;">
							<?php
								...
								if(isset($_GET['course_id']) && isset($_GET['type']))
								{
									...
									$t=$_GET['course_id'];
									$type=$_GET['type'];
									$sqld="SELECT * from notes WHERE teacher_id=$teacher_id and cat='$t' and type='$type'";
									// echo "<h1>Query here ".$sqld."</h1>";
								}
								else if(isset($_GET['course_id']))
								{
									$t=$_GET['course_id'];
									$sqld="SELECT * from notes WHERE cat='$t' and teacher_id=$teacher_id";
									// echo "<h1>second</h1>";
								}
								else
								{
									
									$sqld="SELECT * from notes WHERE teacher_id=$teacher_id";
								}
								// echo "<h1>hey look here ".$_GET['type']."</h1>";
								...
								<div class="mr_card">
									...
									<div class="mr_card_body">
										...
										<div class="title d-flex justify-content-between" style="padding-left: 30px;">
											...
											<a class="p" href="<?php echo $path;?>" title="click here to download" download><?php echo $val['title'];?></a>
										<div style="margin-left: 15px";>
											<?php
											 if($val['status_notes']==0)
											 {
