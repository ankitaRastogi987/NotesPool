						...
						<div class="create-quiz-section">
	                      ...
	                      <div class="add-questions-section">
	                      	...
	                      	?>
			                      	<div class="col-md-6 alert alert-success">
										<strong>Done! </strong>Exam Completed Successfully.
									</div>
							<?php
								}
							?>
	                      ...
	                      <select class="form-control quiz_id col-lg-6" name="quiz_id" id="exampleTextarea1" rows="4"  required>
							...
							<?php
								...
								include 'sql_connection.php';
								$sql="SELECT * from quiz_details where quiz_course = (SELECT cou from course WHERE id=$c)";
								$result=mysqli_query($conn,$sql);
	                        ...
	                        <br>
	                	 <div>
	                	 		<span id="display_questions"></span>
...
<script type="text/javascript">
	...
	{
		$('select.quiz_id').change(function(event) {
			// alert('done');
			// var quiz_id=$('.quiz_id_ar');
			var quiz_id=$(this).children("option:selected").val();
			// alert("id"+quiz_id);
