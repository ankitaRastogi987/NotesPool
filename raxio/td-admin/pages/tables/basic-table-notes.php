      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Notes Table</h4>
                    <p class="card-description">Notes details
                    </p>
                            ...
                            {?>
                                ...
                                <tr>
                                  <td>
                                    <?php
                                      $t=$val['teacher_id'];
                                      $sql1="SELECT name from signup WHERE role='teacher' AND id=$t";
                                      // echo $sql;
                                  ...
                                  <td><a href="pdf_full.php" target="_blank" style="text-decoration: none;">View File</a></td>
                                  <td><?php echo $val['title'];?></td>
                                  <td><?php echo $val['detail'];?></td>
                                  <td><?php echo $val['cat'];?></td>
                                  <td>
                                      <a class="badge badge-danger" href="status_notes.php?id=<?php echo $val['id']?>&role=student">
                                        <?php
