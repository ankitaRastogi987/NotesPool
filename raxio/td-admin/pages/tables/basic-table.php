            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">                  
                  <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table.php">Student Data</a></li>
                          ...
                          if(mysqli_num_rows($result)>0)
                          {
                            ...
                            {?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <a class="badge badge-danger" href="status.php?id=<?php echo $val['id']?>&role=student">
                                        <?php
                                          if($val['status']==0)
                                          {
                                            echo "Panding";
