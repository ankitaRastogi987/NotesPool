...
<body class="body-class">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent" style="padding-top: 21px;">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item">
								<a class="nav-link ar-head" href="index.php" style="color: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
    letter-spacing: .5px;">Home</a>
							</li>
							<li class="nav-item">
    ...
    letter-spacing: .5px;">About Us</a>
							...
							<li class="nav-item">
								<a class="nav-link" href="contact.php"  style="color: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
    letter-spacing: .5px;">Contact Us</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="login.php" title="Login Here"  style="color: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
    letter-spacing: .5px;">Sign in</a>
							</li>
						</ul>
						<a class="mamunur_rashid_top_book_btn" href="register.php" title="Register Here"  style="color: black; background: white;font-size: 18px;
    font-weight: 500;
    text-transform: capitalize;
    letter-spacing: .5px;">Join Now</a>
					</div>
				</div>
			</nav>
