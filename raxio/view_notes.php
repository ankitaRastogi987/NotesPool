		...
		<ul class="nav-item">
              ...
              <div class="collapse" id="ui-basic<?php echo $count;$count++;?>">
                <ul class="nav flex-column sub-menu">       
                  <li class="nav-item"> <a class="nav-link" href="view_notes.php?course_id=<?php echo$cou;?>">All</a></li>           
                  <li class="nav-item"> <a class="nav-link" href="view_notes.php?course_id=<?php echo$cou;?>&&type=Subject_Notes">Subject Notes</a></li>
                  <li class="nav-item"> <a class="nav-link" href="view_notes.php?course_id=<?php echo$cou;?>&&type=Syllabus">Syllabus</a></li>
                  <li class="nav-item"> <a class="nav-link" href="view_notes.php?course_id=<?php echo$cou;?>&&type=Question_bank">Question bank</a></li>
                  <li class="nav-item"> <a class="nav-link" href="view_notes.php?course_id=<?php echo$cou;?>&&type=Previous_year_ppr">Previous year ppr</a></li>
                </ul>
              </div>
        </ul>
        <?php 
						...
						<div class="row mamunurrashid_gig_wraper" style="margin-top: 0px;">
							<?php
								if(isset($_GET['course_id']) && isset($_GET['type']))
								{
									...
									$t=$_GET['course_id'];
									$type=$_GET['type'];
									$sqld="SELECT * from notes WHERE cat='$t' and type='$type'";
